...
import 'package:flutter_member_mvvm/routes/routess.dart';
...
class NavigatorUtil {
  ...
  static void goIndexPage(BuildContext context) {
    Application.router.navigateTo(context, Routess.indexPage, replace: true);
  }
...
//  // 跳转到主页面IndexPage并删除当前路由
  ...
  // 登录判断
  static Future jumpLoginState(BuildContext context,
    ...
    if (Provide.value<Counter>(context).user == null) {
      title = Routess.login;
